...
def read_mcp_server(mcp_server_id: int, db: Session = Depends(get_db)):
...
def update_mcp_server(mcp_server_id: int, mcp_server: mcp_server_schema.McpServerCreate, db: Session = Depends(get_db)):
...
async def get_mcp_server_prompts(mcp_server_id: int, db: Session = Depends(get_db)):
